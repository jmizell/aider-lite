...
from aider_lite import __version__
from aider_lite.args_formatter import (
    DotEnvFormatter,
...
def get_parser(default_config_files, git_root):
    parser = configargparse.ArgumentParser(
        description="aider-lite is AI pair programming in your terminal",
        add_config_file_help=True,
        default_config_files=default_config_files,
        config_file_parser_class=configargparse.YAMLConfigFileParser,
        auto_env_var_prefix="AIDER_LITE_",
    )
    ...
    group.add_argument(
        ...
        default=".aider_lite.model.settings.yml",
        help="Specify a file with aider_lite model settings for unknown models",
    )
    group.add_argument(
        "--model-metadata-file",
        metavar="MODEL_METADATA_FILE",
        default=".aider_lite.model.metadata.json",
        help="Specify a file with context window for unknown models",
    )
    group.add_argument(
        "--verify-ssl",
    ...
    default_input_history_file = (
        os.path.join(git_root, ".aider_lite.input.history") if git_root else ".aider_lite.input.history"
    )
    default_chat_history_file = (
        os.path.join(git_root, ".aider_lite.chat.history.md") if git_root else ".aider_lite.chat.history.md"
    )
    group.add_argument(
        "--input-history-file",
    ...
    group.add_argument(
        ...
        default=None,
        help="Log the conversation with the LLM to this file (for example, .aider_lite.llm.history)",
    )
    ...
    group.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Enable/disable streaming responses (default: False)",
    )
    group.add_argument(
        "--user-input-color",
        default="#00cc00",
    ...
    group.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Enable/disable looking for a git repo (default: False)",
    )
    group.add_argument(
        "--gitignore",
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Enable/disable adding .aider_lite* to .gitignore (default: False)",
    )
    ...
    group.add_argument(
        ...
        help="Specify the aider_lite ignore file (default: .aiderignore in git root)",
    )
    group.add_argument(
        "--subtree-only",
        action="store_true",
    ...
    group.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Attribute aider_lite code changes in the git author name (default: True)",
    )
    group.add_argument(
        "--attribute-committer",
        action=argparse.BooleanOptionalAction,
        default=True,
        help="Attribute aider_lite commits in the git committer name (default: True)",
    )
    group.add_argument(
        "--attribute-commit-message-author",
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Prefix commit messages with 'aider_lite: ' if aider_lite authored the changes (default: False)",
    )
    group.add_argument(
        "--attribute-commit-message-committer",
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Prefix all commit messages with 'aider_lite: ' (default: False)",
    )
    group.add_argument(
        "--commit",
        action="store_true",
    ...
    group.add_argument(
        ...
        metavar="CONFIG_FILE",
        help=(
            "Specify the config file (default: search for .aider_lite.conf.yml in git root, cwd"
            " or home directory)"
        ),
    )
    group.add_argument(
