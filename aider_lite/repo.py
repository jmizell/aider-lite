...
from aider_lite import prompts, utils
from aider_lite.sendchat import simple_send_with_retries
...
class GitRepo:
    ...
    def commit(self, fnames=None, context=None, message=None, aider_edits=False):
        ...
        if aider_edits and self.attribute_commit_message_author:
            commit_message = "aider_lite: " + commit_message
        ...
        committer_name = f"{original_user_name} (aider_lite)"
