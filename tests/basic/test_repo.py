...
class TestRepo(unittest.TestCase):
    ...
    @patch("aider_lite.repo.simple_send_with_retries")
    ...
    @patch("aider_lite.repo.GitRepo.get_commit_message")
    def test_commit_with_custom_committer_name(self, mock_send):
        ...
        with GitTemporaryDirectory():
            ...
            self.assertEqual(commit.author.name, "Test User (aider_lite)")
            self.assertEqual(commit.committer.name, "Test User (aider_lite)")
