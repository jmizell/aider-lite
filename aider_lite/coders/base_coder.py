...
from aider_lite import __version__, models, prompts, urls, utils
from aider_lite.commands import Commands
from aider_lite.exceptions import LiteLLMExceptions
from aider_lite.history import ChatSummary
from aider_lite.io import ConfirmGroup, InputOutput
from aider_lite.linter import Linter
from aider_lite.repo import ANY_GIT_ERROR, GitRepo
from aider_lite.run_cmd import run_cmd
from aider_lite.sendchat import RETRY_TIMEOUT, send_completion
from aider_lite.utils import format_content, format_messages, format_tokens, is_image_file
...
class Coder:
    ...
    def create(
        ...
        **kwargs,
        ...
        import aider_lite.coders as coders
    ...
    def __init__(
        ...
        if use_repo_map and self.repo and has_map_prompt:
            self.repo_map = None # TODO implement repo map
    ...
    def get_repo_map(self, force_refresh=False):
        return # TODO implement repo map
    ...
    def show_undo_hint(self):
        ...
        if self.commit_before_message[-1] != self.repo.get_head_commit_sha():
            self.io.tool_output("You can use /undo to undo and discard each aider_lite commit.")
